...
Consommables · Réparation · Technique

# Sintobois bi-composant — *pourquoi c'est le seul produit* que j'utilise pour réparer un parquet
...
Définition — Pâte à bois bi-composant
...
Mécanisme de durcissement — Sintobois bi-composant
...
❌ Pâte monocomposant (grande surface)
...
✓ Sintobois bi-composant (professionnel)
...
Le problème du retrait — explication
...
C'est quoi le Sintobois bi-composant ?

Une résine de réparation bois à deux composants — résine polyester et durcisseur — à mélanger avant application. Le durcissement se fait par réaction chimique (polymérisation) sans évaporation. **Zéro retrait, zéro fissure**, solidité proche du bois.

Pourquoi ne pas utiliser une pâte à bois classique ?

Les pâtes monocomposants sèchent par évaporation d'eau — elles **se rétractent légèrement** en séchant. Sur un joint ou un trou profond, ce retrait crée un creux visible après ponçage. Elles fissurent aussi avec les mouvements saisonniers du bois. Sur 700+ chantiers, je n'ai jamais eu à refaire une réparation faite au Sintobois.
...
Non — seulement les joints larges (> 4 mm) qui posent un problème esthétique. Les petits joints (≤ 2 mm) se laissent tels quels — ils permettent au bois de respirer. Voir le [guide complet sur les joints de parquet](joints-lames-parquet-reboucher-conseils.html).

Guide connexe
[Joints de parquet — faut-il les reboucher ? La réponse complète](joints-lames-parquet-reboucher-conseils.html)

Guide connexe
[Fond dur et sous-couche — à quoi ça sert vraiment ?](fond-dur-sous-couche-vitrification-parquet-paris.html)

Guide connexe
[Bona Mega Evo — normes COV et certifications environnementales](bona-mega-evo-normes-environnementales-cov-parquet.html)

Guide connexe
[Vitrification parquet Paris — Bona Mega Evo 3 couches](vitrification-bona-mega-evo-paris.html)
