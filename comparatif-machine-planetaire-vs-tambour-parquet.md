...
| Critère | Machine planétaire HTC | Machine tambour |
| --- | --- | --- |
| Principe | 3 disques satellites multidirectionnels | 1 cylindre abrasif directionnel |
| Marques directionnelles | Aucune | Oui — dans le sens du cylindre |
| Parquet point de Hongrie | Parfaitement adapté | Marques irréversibles |
| Parquet Versailles | Parfaitement adapté | Marques irréversibles |
| Parquet droit (lames parallèles) | Adapté | Adapté si dans le sens des lames |
| Génération de poussière | Pratiquement nulle (aspiration intégrée) | Importante |
| Aspiration | Centrale intégrée + HEPA | Externe, moins efficace |
| Vitesse d'avancement | 20 m²/jour | 20-25 m²/jour |
| Risque d'endommagement | Faible | Élevé sur motifs diagonaux |
| Prix matériel | Élevé (>10 000 €) | Moins cher |
| Recommandé pour parquets anciens | Oui — standard professionnel | Non |

## Recommandations par profil

Parquet point de Hongrie ou Versailles

Machine planétaire — obligatoire

La machine tambour laisse des marques directionnelles irréversibles sur les motifs diagonaux. Il n'y a pas d'alternative.

Parquet droit lames parallèles

Machine planétaire — recommandée

La machine tambour peut fonctionner dans ce cas si elle travaille strictement dans le sens des lames. Mais la planétaire reste supérieure.

Parquet haussmannien ancien irremplaçable

Machine planétaire — impérative

Un parquet de 150 ans ne se remplace pas. Le risque d'une machine tambour sur ce patrimoine est inacceptable.

Budget serré, parquet récent droit

Machine tambour — acceptable
