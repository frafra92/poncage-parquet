...
3 couches systématiques avec égrenage entre couche 1 et 2. Base aqueuse, non jaunissant, classé pour un usage domestique intensif et commercial. Mat, satiné ou brillant. Réintégration 8h après la dernière couche.
...
3-4 photos du parquet, surface, étage, meublé ou non. Réponse rapide.
...
François Gaillard intervient personnellement. Pas de sous-traitance.

4

### Réintégration

8 heures après la dernière couche de [Bona Mega Evo](https://www.bona.com/fr/produits/professionnels/protections/vernis/wood-floor-lacquers/bona-mega-evo-sm-ml-3x5l/ "Fiche produit officielle Bona Mega Evo — bona.com"). Le soir même.

**Ce que François Gaillard ne fait pas :** pas de pose de parquet neuf, pas de parquet stratifié ou contrecollé, pas de carrelage, pas de peinture. Cette spécialisation exclusive garantit une maîtrise maximale sur les parquets anciens — c'est le choix de l'excellence, pas de la polyvalence.
